        ...
        <div className="flex items-center gap-3">
          <label className="text-sm">
            ...
            <select
              ...
              className="ml-2 p-1 border h-8 rounded focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            >
              {[5, 10, 20, 50].map((size) => (

...
const TimeNode = ({ id, data }: NodeProps) => {
  ...
  return (
    <div
      className={`group w-[100px] h-[100px] ${COLOR_SHAPE_FLOW_DIAGRAM.time} relative`}
      onDoubleClick={() => setIsEditing(true)}
    >
      <div className="flex items-center justify-center flex-col">
        <div className="text-sm text-center break-all">Time</div>
        {isEditing ? (
          <input
            type="text"
            value={label}

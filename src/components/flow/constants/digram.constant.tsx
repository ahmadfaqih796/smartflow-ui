...
export const COLOR_SHAPE_FLOW_DIAGRAM : Record<string, string> = {
  start: "bg-green-500 text-white flex items-center justify-center cursor-move rounded-4xl border-2 border-green-700",
  end: "bg-red-500 text-white flex items-center justify-center cursor-move rounded-4xl border-2 border-red-700",
  rectangle: "bg-blue-500 rounded-sm text-white flex items-center justify-center cursor-move border-2 border-blue-700",
